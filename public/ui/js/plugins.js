...
var Intense = (function() {
    ...
    function removeViewer() {
      $(container).siblings().last().remove();
      unlockBody();
      unbindEvents();
      stop();
